...
export default function SignInPage() {
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="bg-white/80 rounded! dark:bg-zinc-900/50 backdrop-blur-xl border border-gray-200 dark:border-gray-700/50 p-8 shadow-2xl">
        ...
        <div className="space-y-3">
          <Button
            className="w-full px-4 py-3 rounded  bg-gray-900 dark:bg-white text-white dark:text-gray-900 font-semibold hover:bg-gray-800 dark:hover:bg-gray-100 transition-all duration-200 flex items-center justify-center gap-2 border border-gray-300 dark:border-gray-700"
            variant={"outline"}
            disabled={loading}
            onClick={async () => {
          ...
          <Button
            className="w-full px-4 py-3 rounded bg-white dark:bg-gray-800 text-gray-900 dark:text-white font-semibold hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-200 flex items-center justify-center gap-2 border border-gray-300 dark:border-gray-700"
            disabled={loading}
            onClick={async () => {
              await authClient.signIn.social(
                {
