            ...
            <div className="relative z-10 max-w-2xl mx-auto text-center space-y-8">
                ...
                <div className="pt-8 border-t border-zinc-200 dark:border-zinc-800">
                    <p className="text-sm text-zinc-600 dark:text-zinc-400">
                        Need help?{' '}
                        <Link href="/nextjs-demo/demo" className="text-zinc-900 dark:text-zinc-100 hover:underline font-medium transition-colors">
                            Browse documentation
                        </Link>
                        {' '}or{' '}
                        <Link href="/nextjs-demo" className="text-zinc-900 dark:text-zinc-100 hover:underline font-medium transition-colors">
                            explore features
                        </Link>
                    </p>
                </div>
