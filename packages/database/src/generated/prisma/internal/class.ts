...
/**
   ...
   * `prisma.quotePost`: Exposes CRUD operations for the **QuotePost** model.
    ...
    * ```
    */
  get quotePost(): Prisma.QuotePostDelegate<ExtArgs, { omit: OmitOpts }>;
